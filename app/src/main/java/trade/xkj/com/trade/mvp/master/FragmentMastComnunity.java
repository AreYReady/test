...
public class FragmentMastComnunity extends BaseFragment {
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyHolder> {
        ...
        public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyHolder holder = new MyHolder(LayoutInflater.from(context).inflate(R.layout.rv_item_mast_community, parent,false));
            return holder;
        }
