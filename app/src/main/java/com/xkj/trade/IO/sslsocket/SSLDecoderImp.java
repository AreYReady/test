...
import com.xkj.trade.bean.BeanServerTime;
import com.xkj.trade.bean.BeanSymbolConfig;
import com.xkj.trade.bean.DataEvent;
...
import static com.xkj.trade.constant.TradeDateConstant.diffTimeServiceAndNative;
...
//                    BeanUserList userInfo = new Gson().fromJson(resultMessage, BeanUserList.class);
